...
module.exports = [
    ...
    new Node([setFamily(4, 111), setFamily(8, 70)], 'Lugoj'), // 5
    ...
    new Node([setFamily(10, 120), setFamily(7, 146), setFamily(9, 138)], 'Craiova'), // 11
    new Node([setFamily(13, 90), setFamily(14, 85)], 'Bucharest'), // 12
    new Node([setFamily[12, 90]], 'Giurgiu'), // 13
    new Node([setFamily(12, 85), setFamily(15, 98), 17, 142], 'Urziceni'), // 14
    new Node([setFamily(14, 98), setFamily(16, 86)], 'Hirsova'), // 15
    new Node([setFamily(15, 86)], 'Eforie'), // 16
    new Node([setFamily(15, 142), setFamily(18, 92)], 'Vaslui'), // 17
    new Node([setFamily(17, 92), setFamily(19, 87)], 'Iasi'), // 15
